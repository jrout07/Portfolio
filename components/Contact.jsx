...
const Contact = () => {
  ...
  const onSubmit = async (event) => {
    ...
    formData.append("access_key", "f8668165-d8e5-46b6-b12a-1c5dbcfc3246");
  ...
  return (
    ...
    id='contact' className='w-full px-[12%] py-10 scroll-mt-20 bg-[url("/footer-bg-color.png")] bg-no-repeat bg-center bg-[length:90%_auto] dark:bg-none'>
      ...
      Got a thought, a challenge, or an exciting idea? I'm all ears. Fill out the form below and let's explore what we can build together.</motion.p>
